...
<body>
    <section class="Login">
        <div class="form-container">
            ...
            <h1 class="subsubtitle">Vista: Docente sin asignatura</h1>
            ...
            $v_usuario =  'postgres';
            $v_password = 123456;
            $v_tabla =    'docente_sin_asignaturar';
            ...
            <form action="/" class="form">
                ...
                /*Llamado e impresión de dtos*/
                    if ($v_tabla == "docente_sin_asignaturar") {
                ...
                /*Impresión row a row a partir del array pg_fetch_array*/
                    ?>
                            <tr>
                                <td class="subtitle"><?php echo $row["id"]; ?></td>
                                <td class="subtitle"><?php echo $row["nombre"]; ?></td>
